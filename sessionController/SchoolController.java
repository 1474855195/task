...
import modelController.viewerController.MainXhtml_1;
...
//                }
    ...
    public List<School> getAllClasses() {
        if (null == subjectController.getSelected() || null == subjectController.getSelected().getId()) {
            ...
            String temSQL = "select * from teacschoolsubject where teacherid=" + teacherAdminController.getLogined().getId()
